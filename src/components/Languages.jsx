...
const Languages = () => {
  return (
    <section className="  grid grid-cols-2 h-[320px] pt-0 justify-items-center md:grid-cols-6 md:h-[150px] md:items-center  text-3xl font-sen">
      ...
      <div className="flex flex-col text-center justify-e font-sen font-semibold text-lg">
        <span className="text-[#8491A0]">Node JS</span>
       
        <span>
          <i className="text-3xl bx bxl-nodejs from-[#2da839] via-[#1fea3a] to-[#31ca4f] bg-gradient-to-r bg-clip-text text-transparent"></i>
        </span>
      </div>


      <div className="flex flex-col text-center justify-e font-sen font-semibold text-lg">
        <span className="text-[#8491A0]">Redux</span>
       
        <span>
          <i className="text-3xl bx bxl-redux from-[#1482cb] via-[#02d4d0] to-[#00d6f2] bg-gradient-to-r bg-clip-text text-transparent"></i>
        </span>
      </div>
    </section>
  );
