      ...
      <article className="grid md:grid-cols-2 lg:grid-cols-4  ">
        <section  className="p-3   xl:p-4">
          <div  className="xl:p-6">
            ...
            <p className=" px-6 text-2xl font-sen  text-white font-semibold">
              <b className="text-[#3CC74E] font-semibold">Google</b>,
        ...
        <section className="p-3  xl:p-4">
          <div   className="xl:p-6">
            ...
            <p className=" px-6 text-2xl font-sen  text-white font-semibold">
              <b className="text-[#609BFF] font-semibold">Google</b>, Product
              Designer{" "}
            </p>
        ...
        <section className="p-3 xl:p-4">
          <div className="xl:p-6">
            ...
            <p className=" px-6 text-2xl font-sen  text-white font-semibold">
              <b className="text-[#E95D90] font-semibold">Dribble</b>, Graphic
              Designer{" "}
            </p>
        ...
        <section className="p-3 xl:p-4">
          <div className="xl:p-6">
            ...
            <p className=" px-6 text-2xl font-sen  text-white font-semibold">
              <b className="text-[#5de7e9] font-semibold">Dribble</b>, Graphic
              Designer{" "}
            </p>
